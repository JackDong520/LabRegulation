...
public class LogupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lugup);


        editTextUserName = (EditText) findViewById(R.id.edit_text_user_name_logup);
        editTextUserPassword = (EditText) findViewById(R.id.edit_text_user_password_logup);
